...
**[在线体验](https://zhx8702.github.io/port-meridian/train/)** · **[返回 Demo 目录](../README.md)** · **[历史 Release](https://github.com/zhx8702/port-meridian/releases/tag/v1.0.0)** · **[复现提示词](PROMPT.md)**
...
2. 用 Chrome 打开 `train/index.html`。
